            ...
            {[
              {
                ...
                role: '焊接／修補',
                line:
                  '「我做焊接同修補，最撚憎就係啲人講兩句就想我即刻變魔術。你話趕？得，OT 我都可以頂硬上，但你要畀清楚圖、尺寸同現場位，唔好一陣又改、又話『其實我想另一款』，搞到我拆完又焊返，浪費時間又危險。啲位唔work我會直講，唔係我串，係真係行唔通。做得地盤，粗口係標點符號，但我做嘢係認真：焊位要實、角度要正、收口要靚，唔係裝飾品咁簡單。你俾我一個準，我俾你一個穩陣。」',
              },
              {
                name: '阿玲師傅',
                role: '度尺／安裝',
                line:
                  '「我負責度尺同安裝，講白啲：冇度清楚，你後面一定出事。好多客一開始話『差唔多啦』，我心諗：差唔多你就等於差好多。門口斜少少、牆身唔直、地台高低位，全部都會影響件鐵器合唔合、開唔開到、會唔會刮手。有人鍾意呃自己：『應該得㗎喇』——我會即刻回一句：唔係呀！真係唔係。你話我煩？係，我煩係因為想一次做啱，唔想返工返到變補鑊。安裝嗰陣我都會催：行開啲啦，唔好阻住，安全第一。做得穩陣，先至係型。」',
              },
              {
                name: '大偉師傅',
                role: '安全／監督',
                line:
                  '「我做安全同監督，唔係扮警察，我係幫大家返到屋企。地盤最驚就係『趕』：一趕就亂，一亂就出事。你哋想快？我都想快，但唔可以用命去換。有人企到焊火隔離、又伸手摸件嘢，我真係忍唔住會屌：唔好阻住！行開！你以為好玩咩？我見過太多小意外變大鑊，唔想你哋中招。做工程唔係靠口水，係靠程序：拉線、固定、承重、驗收，一樣都唔可以偷雞。你俾我守好安全位，我俾你成單嘢順順利利交收，唔使返轉頭補救，大家都開心。」',
              },
            ].map((p) => (
              <div
                key={p.name}
